...
<div class="bg-white boxer container mt-3">
    ...
    <h3 class="h3">Create New Event</h3>
        ...
        <div class="col-4">
        <a href="{{route('events.create')}}" class="btn-theme mt-4">Create Event</a>
        </div>
    </div>
</div>
<div class="bg-white boxer container mt-3">
    <h3 class="h3">Events List</h3>
    <center><div>
          ...
          <td class="text-center" scope="row"> <img src="{{asset('image/'.$row->image)}}" width="50" height="40" alt=""> </td>
            ...
            <td class="text-center" scope="row">{{$row->description}}</td>
             ...
             <td class="text-center" scope="row">
                 <div class="row">
                 <div class="col-6"> <a href="{{url('events/'.$row->id.'/edit')}}" class="btn-theme-border"> Edit </a> </div>
                     <a href="{{route('events.destroy',array('event'=>$row->id))}}" class="btn-theme"> Delete </a>
                    </div>
                </div>
                </td>
