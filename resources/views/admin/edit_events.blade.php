...
<h3 class="h3 text-center">Edit Event </h3>
<center><div>
    ...
    <div class="row">
        ...
        <form action="{{route('events.update',array('event'=>$events->id))}}" method="POST" class="form" enctype="multipart/form-data">
        @csrf
        <div class="form-group mt-3">
            <div class="row">
            <div class="col-4 mt-2"><label>Event Title</label> </div>
       <div class="col-8">
           <input type="text" name="title" value="{{$events->title}}" class="form-control border-top-0 border-right-0 border-left-0" required>
    ...
    <div class="form-group mt-3">
        <div class="row">
        <div class="col-4 mt-2"><label>Enter Event Descrption</label> </div>
   <div class="col-8">
       <textarea  name="descerption" value="" class="form-control border-top-0 border-right-0 border-left-0" required>{{$events->description}}</textarea>
...
<div class="form-group mt-3">
    <div class="row">
    <div class="col-4 mt-2"><label>Event Image</label> </div>
<div class="col-8">
...
<img src="{{asset('image/'.$events->image)}}" class="profile-image mx-auto d-block img-fluid" id="db_img" alt="">
    @endif
</div>
</div>
</div>
