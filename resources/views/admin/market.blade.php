...
<div class="bg-white boxer container mt-3">
    <h3 class="h3" style="display: inline;">Market List</h3>
    <a data-toggle="modal" href="#service" class="btn-theme mt-3" style="float: right;">Add New Market</a>
    <br clear="all">
    <center><div>
        ...
        <tbody>
          ...
          <tr>
             ...
             <td class="text-center" scope="row">
                <a href="{{route('del_market',array('id'=>$row->id))}}" class="btn-theme-border"> Delete </a>
            </td>
...
<div class="modal fade" id="service" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{route('add_market')}}" method="post">
            @csrf
                <div class="form-group">
                    <input type="text" name="market" placeholder="Enter Market Typr" class="form-control" required>
                </div>
